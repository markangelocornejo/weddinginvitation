  ...
  return (
    <section className="relative overflow-hidden px-5 py-24 text-center sm:px-7 sm:py-28">
      ...
      >
        ...
        <div className="relative mx-auto mt-10 grid max-w-md gap-8 text-left sm:max-w-2xl sm:grid-cols-2 sm:gap-3 sm:text-center lg:mt-14 lg:max-w-4xl">
          <span className="absolute bottom-auto left-[1.1rem] top-0 h-full w-px bg-[#D5B892]/80 sm:left-0 sm:right-0 sm:top-[1.45rem] sm:h-px sm:w-full" />
